...
def main(model: str, interface: str):
    ...
    #         [0.05, 0.0, 0.08, 0.0, 0.2, 0.0],
    #         [0.05, 0.0, 0.08, 0.0, 0.4, 0.0],
    #         [0.05, 0.0, 0.08, 0.0, 0.6, 0.0],
    #         [0.05, 0.0, 0.08, 0.0, 0.8, 0.0],
    #         [0.05, 0.0, 0.08, 0.0, 1.0, 0.0],
    #         [0.05, 0.0, 0.08, 0.0, 1.2, 0.0],
    #         [0.05, 0.0, 0.08, 0.0, 1.4, 0.0],
    #         # [0.05, 0.0, 0.08, 0.0, 1.6, 0.0],
    #         # [0.05, 0.0, 0.08, 0.0, 1.8, 0.0],
    #         # [0.05, 0.0, 0.08, 0.0, 2.0, 0.0],
    #     ]
    # )
    cartesian_waypoints = np.array([home_pose.tolist(),
                                    [0.3, 0.0, 0.15, 0.0, 1.35, 0.0], 
                                    [0.3, 0.0, 0.01, 0.0, 1.35, 0.0], 
                                    [0.3, 0.08, 0.01, 0.0, 1.35, 0.0]])    
